...
- **Повреждённые координаты:** повреждённые payload пропускаются при парсинге; после успешной отправки все coordinate-действия (включая нераспарсенные) удаляются из очереди, чтобы не засорять хранилище.
